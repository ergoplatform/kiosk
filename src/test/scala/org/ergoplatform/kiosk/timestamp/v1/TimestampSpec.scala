package org.ergoplatform.kiosk.timestamp.v1

import org.ergoplatform.kiosk.ergo.{DhtData, KioskBox, KioskCollByte, KioskInt}
...
class TimestampSpec extends AnyPropSpec with Matchers {
