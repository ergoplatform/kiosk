...
class ScriptSpec extends AnyWordSpec with Matchers {
  "Kiosk" should {
    ...
    "decode address #2 correctly" in {
      ...
      ergoAddressEncoder.toString(ScalaErgoConverters.getAddressFromString("9hTh4u6CDXktMQb9BoRo5nTPnmFN8G5u4PUCURvoUCXmtaaDYdw")) shouldBe "9hTh4u6CDXktMQb9BoRo5nTPnmFN8G5u4PUCURvoUCXmtaaDYdw"
    }
